...
public class CarParkParserTest {
    ...
    public void when_aStreamContainsACarPark_itWillBeParsed() throws Exception {
        ...
        CarPark expectedCarPark = new CarPark(expectedId, expectedCarparkName, expectedLattitude, expectedLongitude, expectedCapacity, expectedSpacesAvailable, expectedPredicted30Mins, expectedPredicted60Mins);

        List<CarPark> carParks = parser.parse(testResourceStream("[{ \"Id\": " + expectedId + ", \"Name\": \"" + expectedCarparkName + "\", \"State\": \"Spaces\", \"LastUpdated\": \"2015-12-30T12:00:00\", \"Latitude\": " + expectedLattitude + ", \"Longitude\": " + expectedLongitude + ", \"SCN\": \"ignored\", \"Capacity\": " + expectedCapacity + ", \"SpacesNow\": " + expectedSpacesAvailable + ", \"PredictedSpaces30Mins\": " + expectedPredicted30Mins + ", \"PredictedSpaces60Mins\": " + expectedPredicted60Mins + "}]"));
