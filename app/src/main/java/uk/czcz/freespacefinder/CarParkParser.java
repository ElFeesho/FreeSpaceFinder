        ...
        try {
            ...
            else
            {
                ...
                for (int i = 0; i < carParks.length(); i++) {
                    ...
                    carParkList.add(new CarPark(carParkObject.getInt("Id"), carParkObject.getString("Name"), carParkObject.getString("State"), new LastUpdateTimestamp(carParkObject.getString("LastUpdated")), carParkObject.getDouble("Latitude"), carParkObject.getDouble("Longitude"), carParkObject.getInt("Capacity"), carParkObject.getInt("SpacesNow"), carParkObject.getInt("PredictedSpaces30Mins"), carParkObject.getInt("PredictedSpaces60Mins")));
                }
                return carParkList;
            }
